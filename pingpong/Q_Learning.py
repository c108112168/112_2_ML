            ...
            if ball_speed_y > 0:  # 球向下移動
                ...
                if future_ball_x < 0 or future_ball_x > table_width:
                    if ball_speed_x > 0:
                        ...
                        time_to_wall = abs(ball_x / ball_speed_x)
...
# 打印出球的座標，速度和預測落點
        print(f"Ball position: ({original_ball_x}, {original_ball_y}), Ball speed: ({ball_speed_x}, {ball_speed_y}), Predicted landing position: {ball_x}, time_to_wall: {time_to_wall}")
